...
TEST_IMG_FILEPATH = '../images/receipts/test1.jpg'
...
class TestResizeImage(unittest.TestCase):
    ...
    def test_save02(self):
        ...
        process_image.resize_image(img,
                                   proc_img_folderpath=self.arbitrary_proc_img_folderpath)
        self.assertFalse('resized.jpg' in os.listdir(self.arbitrary_proc_img_folderpath))
...
class TestPrepareImage(unittest.TestCase):
    ...
    arbitrary_proc_img_folderpath = r'../images/test_receipts_processed'
    ...
    def setUpClass(cls):
        ...
        os.makedirs(cls.arbitrary_proc_img_folderpath, exist_ok=True)
    ...
    def test_save02(self):
        ...
        self.assertFalse('resized.jpg' in os.listdir(self.arbitrary_proc_img_folderpath))
        self.assertFalse('adjusted color.jpg' in os.listdir(self.arbitrary_proc_img_folderpath))
        self.assertFalse('outlined.jpg' in os.listdir(self.arbitrary_proc_img_folderpath))
        self.assertFalse('transformed.jpg' in os.listdir(self.arbitrary_proc_img_folderpath))
    ...
    def test_save04(self):
        ...
        self.assertTrue('resized.jpg' in os.listdir(self.arbitrary_proc_img_folderpath))
        self.assertTrue('adjusted color.jpg' in os.listdir(self.arbitrary_proc_img_folderpath))
        self.assertTrue('outlined.jpg' in os.listdir(self.arbitrary_proc_img_folderpath))
        self.assertTrue('transformed.jpg' in os.listdir(self.arbitrary_proc_img_folderpath))
    ...
    def tearDownClass(cls):
        ...
        os.rmdir(cls.arbitrary_proc_img_folderpath)
...
class TestGetContent(unittest.TestCase):
    ...
    output_filepath = r'..\results\test1\raw_content.txt'
